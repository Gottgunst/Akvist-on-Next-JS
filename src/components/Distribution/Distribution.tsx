...
export function Distribution({}: IDistributionProps) {
  return (
    <div className="section distribution">
      ...
      <article className="distribution__about">
        ...
        <p className="section__text distribution__text">
          Аквист — ассоциация компаний «ВИСТ». Мы специализируемся на поставке
          отделочных материалов, солнечных батарей и коллекторов, оборудования
          для горячего водоснабжения и отопления.
        </p>
        <blockquote className="quote distribution__quote">
          Офисы и склады расположены на территории Южного и Северо-Кавказского
          федерального округа, что позволяет осуществлять оперативную поставку
          материалов.
        </blockquote>
      </article>
    </div>
...
export default Distribution as unknown as (
